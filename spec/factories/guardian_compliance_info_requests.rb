...
FactoryBot.define do
  factory :guardian_compliance_info_request do
    ...
    trait :first_name_request do
      field_needed { UserComplianceInfoFields::Guardian::FIRST_NAME }
    end

    trait :last_name_request do
      field_needed { UserComplianceInfoFields::Guardian::LAST_NAME }
    end

    trait :email_request do
      field_needed { UserComplianceInfoFields::Guardian::EMAIL }
    end

    trait :phone_request do
      field_needed { UserComplianceInfoFields::Guardian::PHONE }
    end

    trait :tax_id_request do
      field_needed { UserComplianceInfoFields::Guardian::TAX_ID }
    end

    trait :address_request do
      field_needed { UserComplianceInfoFields::Guardian::Address::STREET }
    end

    trait :document_request do
      field_needed { UserComplianceInfoFields::Guardian::STRIPE_IDENTITY_DOCUMENT_ID }
    end
  end
end
