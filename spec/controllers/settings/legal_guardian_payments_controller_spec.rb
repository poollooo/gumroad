...
RSpec.describe Settings::PaymentsController, type: :controller do
  ...
  describe "Integration with Stripe events" do
    ...
    it "maps Stripe guardian fields to internal fields correctly" do
      "legal_guardian.first_name"
      "guardian_first_name"

      # Test that the mapping exists in StripeMerchantAccountManager
      expect(StripeMerchantAccountManager).to respond_to(:handle_legal_guardian_requirements)
    end
